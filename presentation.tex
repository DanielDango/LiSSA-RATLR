...
\begin{frame}{PIBA}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{images/LiSSA_pipeline_Fuchß.png}
...
\begin{frame}{Related Work}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            %Crosssection
            \node[draw, align=center] at (1.75, -1.25) {\large\textbf{my work}};
            \end{scope}
...
\begin{frame}{Thesis Schedule}
    ...
    \ganttset{bar height=.7}
        ...
        \ganttbar{LiSSA \& Benchmark setup}{2025-06-23}{2025-07-06}
        \ganttbar[name=impl1]{}{2025-07-21}{2025-08-03} \\
        \ganttbar{Tree of Thought implementation}{2025-07-07}{2025-07-13} \\
        \ganttgroup{Naive optimization}{2025-07-28}{2025-08-18} \\
        \ganttbar[name=impl2]{Iterative classifier implementation}{2025-07-28}{2025-08-03} \\
