...
\begin{tabularx}{\textwidth}{p{1.3em}l Z  Z  Z  Z  Z }
    ...
    & P.    & 0.376    & 0.392    & 0.528    & 0.528    & \textbf{ 0.541 } \\
    & R.    & \textbf{ 0.691 }    & \textbf{ 0.691 }    & 0.632    & 0.632    & 0.588 \\
    & F\textsubscript{1}    & 0.487    & 0.5    & \textbf{ 0.575 }    & \textbf{ 0.575 }    & 0.563 \\
    \arrayrulecolor{kit-gray30} \midrule \arrayrulecolor{black}

    \multirow{ 3 }{*}{\rotatebox{90}{\Avg}}
    & P.    & 0.368    & 0.379    & 0.405    & \textbf{ 0.474 }    & 0.433 \\
    & R.    & \textbf{ 0.568 }    & \textbf{ 0.568 }    & 0.556    & 0.478    & 0.441 \\
    & F\textsubscript{1}    & 0.44    & 0.447    & \textbf{ 0.461 }    & 0.455    & 0.422 \\
    \arrayrulecolor{kit-gray30} \midrule \arrayrulecolor{black}

    \multirow{ 3 }{*}{\rotatebox{90}{\WeightedAvg}}
    & P.    & 0.385    & 0.399    & 0.434    & \textbf{ 0.494 }    & 0.442 \\
    & R.    & \textbf{ 0.635 }    & 0.633    & 0.618    & 0.498    & 0.408 \\
    & F\textsubscript{1}    & 0.474    & 0.484    & \textbf{ 0.503 }    & 0.485    & 0.414 \\
    \arrayrulecolor{kit-gray30} \midrule \arrayrulecolor{black}
