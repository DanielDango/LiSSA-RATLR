...
public record ClassifierCacheKey(
    ...
    public static ClassifierCacheKey of(String model, int seed, double temperature, Mode mode, String content) {
        return new ClassifierCacheKey(model, seed, temperature, mode, content, KeyGenerator.generateKey(content));
    }
    ...
    public static ClassifierCacheKey ofRaw(
            String model, int seed, double temperature, Mode mode, String content, String localKey) {
        return new ClassifierCacheKey(model, seed, temperature, mode, content, localKey);
    }
