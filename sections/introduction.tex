...
They are becoming increasingly popular for dealing with various tasks and have shown auspicious results so far.
\directQuote{LLMs have demonstrated significant potential in automating and enhancing tasks such as
requirement elicitation, classification, generation, specification
generation, and quality assessment}{jin2025LLMsLLMbased}
...
A replication package for this thesis is also provided \cite{schwab_danieldangoreplication-package-automated-prompt-engineering-for-traceability-link-recovery_2025}.
