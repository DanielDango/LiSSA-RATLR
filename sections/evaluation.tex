...
\Todo{Wo ist \ToT?}
\autoref{sec:Evaluation:naive_optimization}, \autoref{sec:Evaluation:simple_feedback_optimization}, and \autoref{sec:Evaluation:varying-the-optimization-prompt} present the naive prompt optimization approaches.
...
\Todo{Wehe du übersiehst den random Namen hier :monkaW:}
...
\Todo{Aufzählen wer die Metriken benutzt hat.}
\directQuote[sec. 7.1]{
...
This training subset includes three source artifacts with four target artifact candidates each, resulting in up to twelve possible \TLs.
