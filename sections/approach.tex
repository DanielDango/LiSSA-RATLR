...
This already provides the basic components and data to evaluate the more sophisticated algorithm by \citewithauthor{pryzant2023AutomaticPrompt}, which will be implemented in \autoref{approach:sec:gradient_descent}.

\section{Simple Tree-of-Thought Classifier}
\label{approach:sec:tot}

\autoref{fig:ToT_visualization} \Todo{Außerdem bild erklären im text.}
...
Integration for different \LLM providers, such as \OAI, Ollama, and Blablador, already exists in the framework.
...
\autoref{fig:iterative_core_loop} \Todo{Legende einfügen; erklären was die Farben bedeuten etc.}
...
\section{Was auch immer du da getan und nicht mehr umgearbeitet hast seit dem Proposal}
\begin{figure}
    \centering
