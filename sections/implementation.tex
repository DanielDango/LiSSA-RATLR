...
\Todo{Link to subsectsion in Approach}
...
The prompt to be optimized is provided in the module configuration during the optimizers' instantiation.
...
To do so an evaluation pipeline object is created and relevant modules will be retrieved from it.
